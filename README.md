...
Introspection functionality adds capability for already authenticated users and/or applications that
already possess an access token to go through kong. The actual token verification is then done by Resource Server.
